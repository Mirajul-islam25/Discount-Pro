...
const Badge = ({ children, variant = "default", className = "" }) => {
  const base = "inline-flex items-center px-3 py-1 rounded-full text-xs font-medium transition";
  const colors = {
...
const Button = ({ children, variant = "solid", size = "md", asChild = false, className = "", ...props }) => {
  ...
  const variants = {
    ...
    outline: "border border-white bg-transparent text-white hover:bg-white hover:text-blue-600",
    secondary: "bg-white text-blue-600 hover:opacity-90",
    coupon: "bg-gradient-to-r from-yellow-400 to-orange-500 text-white hover:brightness-105",
  };
  const content = (
    <button
...
const sliderSlides = [
  {
    ...
    subtitle: "Discover exclusive deals and discounts from Bangladesh's top brands.",
    cta1: { text: "Browse All Deals", to: "/brands", icon: <ShoppingBag className="mr-2 h-5 w-5" /> },
    cta2: { text: "View Trending", to: "/trending", icon: <TrendingUp className="mr-2 h-5 w-5" /> },
    bgGradient: "bg-gradient-to-r from-blue-600 to-purple-600",
  },
  {
    title: "Limited Time Offers",
    subtitle: "Brands you trust, deals you can't ignore. Grab them before they're gone!",
    cta1: { text: "Shop Now", to: "/brands", icon: <Zap className="mr-2 h-5 w-5" /> },
    cta2: { text: "Trending Picks", to: "/trending", icon: <TrendingUp className="mr-2 h-5 w-5" /> },
  ...
  },
  {
    ...
    cta1: { text: "Get Started", to: "/brands", icon: <Users className="mr-2 h-5 w-5" /> },
    cta2: { text: "Learn More", to: "/about", icon: <ExternalLink className="mr-2 h-5 w-5" /> },
  ...
  <div className="mx-auto relative">
    ...
    >
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            <Button size="xl" variant="secondary" asChild>
              <Link to={sliderSlides[current].cta1.to} className="flex items-center">
                {sliderSlides[current].cta1.icon}
                {sliderSlides[current].cta1.text}
              </Link>
            </Button>
            <Button size="xl" variant="outline" asChild>
              <Link to={sliderSlides[current].cta2.to} className="flex items-center">
      ...
      <section className="py-16 bg-gray-100 dark:bg-gray-800">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6" data-aos="fade-up" data-aos-delay="200">
            ...
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-yellow-500 mb-2">20+</div>
              <div className="text-gray-600 dark:text-gray-300">Active Coupons</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-green-500 mb-2">50%</div>
              <div className="text-gray-600 dark:text-gray-300">Max Savings</div>
            </div>
            <div className="text-center">
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-900">
        <div className="container mx-auto px-4 mb-12">
          <div className="text-center" data-aos="fade-up">
            <h2 className="text-3xl text-gray-300 md:text-4xl font-bold mb-4">Top Brands</h2>
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Discover amazing deals from Bangladesh's most trusted e-commerce platforms
            </p>
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-100 dark:bg-gray-800">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12" data-aos="fade-up">
            <h2 className="text-3xl md:text-4xl text-white font-bold mb-4">🔥 Brands on Sale</h2>
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                ...
                <CardContent className="p-6">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <div className="flex items-center space-x-1">
                          ...
                          <span className="text-sm text-gray-500">{brand.rating}</span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="text-sm text-gray-600 dark:text-gray-300">
                      <span className="font-medium text-blue-600">{brand.coupons.length}</span>{" "}
                      Coupons Available
                    </div>
                  ...
                  <Button className="w-full" variant="coupon" asChild>
                    <Link to={`brand/${brand._id}`} className="flex items-center justify-center">
                      View Coupons
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12" data-aos="fade-up">
            <h2 className="text-3xl text-gray-300 md:text-4xl font-bold mb-4">Why Choose Discount PRO?</h2>
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center" data-aos="fade-up" data-aos-delay="100">
              ...
              <h3 className="text-xl text-blue-500 font-bold mb-2">Instant Savings</h3>
              <p className="text-gray-600 dark:text-gray-300">
                Copy coupon codes instantly and start saving on your purchases right away.
              </p>
            </div>
            ...
            <div className="text-center" data-aos="fade-up" data-aos-delay="200">
              ...
              <h3 className="text-xl text-yellow-400 font-bold mb-2">Best Deals</h3>
              <p className="text-gray-600 dark:text-gray-300">
                Curated collection of the most valuable deals from top brands in Bangladesh.
              </p>
            </div>
            ...
            <div className="text-center" data-aos="fade-up" data-aos-delay="300">
              ...
              <h3 className="text-xl text-green-500 font-bold mb-2">Trusted Platform</h3>
              <p className="text-gray-600 dark:text-gray-300">
                Join thousands of satisfied users who save money daily with our platform.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div data-aos="fade-up">
            ...
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Join our community and never miss a great deal again. Sign up for free today!
            </p>
            <Button size="xl" className="bg-gradient-to-r from-yellow-400 to-orange-500">
              Get Started Now
            </Button>
          </div>
        </div>
